...
class Manifest {
    ...
    async getDeploymentFromAddress(address) {
        ...
        const deployment = Object.values(data.impls).find(d => { var _a; return (d === null || d === void 0 ? void 0 : d.address) === address || ((_a = d === null || d === void 0 ? void 0 : d.allAddresses) === null || _a === void 0 ? void 0 : _a.includes(address)); });
