...
async function getStorageLayoutForAddress(manifest, validations, implAddress) {
    ...
    const versionWithoutMetadata = Object.keys(data.impls).find(v => { var _a, _b, _c; return ((_a = data.impls[v]) === null || _a === void 0 ? void 0 : _a.address) === implAddress || ((_c = (_b = data.impls[v]) === null || _b === void 0 ? void 0 : _b.allAddresses) === null || _c === void 0 ? void 0 : _c.includes(implAddress)); });
